...
public class StepService {
    ...
    public List<StepResponse> listByScenario(UUID scenarioId){
        scenarios.findByModule_Project_User_Id(scenarioId,SecurityUtils.currentUserId())
    ...
    @Transactional
    public StepResponse update(UUID scenarioId, UpdateStepRequest req){
    ...
    public void delete(UUID scenarioId) {
        steps.delete(findOwned(scenarioId));
    }
